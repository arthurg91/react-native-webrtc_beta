...
public class CameraCaptureController extends AbstractVideoCaptureController {
    public interface CapturerObserverFactory {
        CapturerObserver createCapturerObserver(SurfaceTextureHelper surfaceTextureHelper, VideoSource videoSource);
    }

    private static CapturerObserverFactory capturerObserverFactory =
            (surfaceTextureHelper, videoSource) -> videoSource.getCapturerObserver();

    public static CapturerObserverFactory getCapturerObserverFactory() {
        return capturerObserverFactory;
    }

    public static void setCapturerObserverFactory(CapturerObserverFactory capturerObserverFactory) {
        CameraCaptureController.capturerObserverFactory = capturerObserverFactory;
    }
