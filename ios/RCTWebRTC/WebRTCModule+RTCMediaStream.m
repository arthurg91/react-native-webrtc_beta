...
RCT_EXPORT_METHOD(mediaStreamTrackSetWithSpecificReactTagEnabled:(nonnull NSString *)trackID : (BOOL)enabled : (NSString *)streamReactTag)
{
  RTCMediaStreamTrack *track = [self trackForId:trackID fromConnectionWithTag:streamReactTag];
...
- (RTCMediaStreamTrack*)trackForId:(NSString*)trackId fromConnectionWithTag:(NSString*)reactTag {
  RTCMediaStreamTrack *track = self.localTracks[trackId];
